...
/********************* public ****************************/
	...
	public string function processShortcodes(string content) {
		...
		content = $sc_REReplaceCallback(string=content, pattern=$sc_getRegex(), callback=$sc_processTag, scope="all");
		return content;
	}
...
/********************* internal ****************************/
	 ...
	 */
	private string function $sc_getRegex() {
	 ...
	 */
	private string function $sc_processTag(required array parts) {
	 ...
	 */
	private string function $sc_invokeTag(required string tag, required struct attributes, required string content) {
		var o = "";
	 ...
	 */
	private struct function $sc_parseAttributes(required string text) {
		var attrs = {};
		var tokens = [];
		var si = "";
		var qi = "";
	 ...
	 */
	private string function $sc_REReplaceCallback(string string, string pattern, function callback, string scope) {
		var start = 0;
		var match = "";
		var parts = "";
		var replace = "";
